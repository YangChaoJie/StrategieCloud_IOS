...
protocol BackTectChartDataSource: class {
//	func backtestChartData(data: String?)
	
	func backTestChartViewData(bean: BackTestBean?)
}

class BackTestChartViewCell: UITableViewCell, BackTectChartDataSource {
