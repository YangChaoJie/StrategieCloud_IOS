...
protocol ProfitTableViewCellDataSource {
	func profitValue(profit10: Float?, profit60: Float?, profit250: Float?)
}

class ProfitTableViewCell: UITableViewCell, ProfitTableViewCellDataSource {
