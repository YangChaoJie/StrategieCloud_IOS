...
final  class StrategyStockItem : ResponseObjectSerializable, ResponseCollectionSerializableData {
    ...
    init?(response: NSHTTPURLResponse, representation: AnyObject) {
        ...
        self.backtestStart = representation.valueForKeyPath("backtest_start") as? String ?? ""
    }
    
    init(name: String,profit:Double,star:Int,isUsing:Bool,aowId:Int,strategyChartItem : StrategyChartItem,backtestStart: String){
        self.name = name
        self.profit = profit
        self.star = star
        ...
        self.backtestStart = backtestStart
    }
}
