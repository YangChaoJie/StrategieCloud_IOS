...
public class ChartYAxisRenderer: ChartAxisRendererBase
{
    ...
    public override func renderAxisLabels(context context: CGContext)
    {
        ...
        let yoffset = yAxis.labelFont.lineHeight / 2 + yAxis.yOffset
...
//			pt.y += offset
			...
			if yAxis.customAxis {
				...
				if i < midVal {
					attributes = [NSFontAttributeName: labelFont, NSForegroundColorAttributeName: UIColor.KLineDownColor()]
				} else if i == midVal {
					attributes = [NSFontAttributeName: labelFont, NSForegroundColorAttributeName: labelTextColor]
				} else {
					attributes = [NSFontAttributeName: labelFont, NSForegroundColorAttributeName: UIColor.KLineUpColor()]
				}
			} else {
				attributes = [NSFontAttributeName: labelFont, NSForegroundColorAttributeName: labelTextColor]
			}
			
			ChartUtils.drawText(context: context, text: text, point: pt, align: textAlign, attributes: attributes)
		}
