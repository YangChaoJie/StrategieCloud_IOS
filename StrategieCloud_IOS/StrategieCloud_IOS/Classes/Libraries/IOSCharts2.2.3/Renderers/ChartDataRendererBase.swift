...
public class ChartDataRendererBase: ChartRendererBase
{
	...
	public func drawExternalData(context context: CGContext, withIndices indices: [ChartHighlight], completionHandle: ([ExternalData]) -> Void) {
		fatalError("drawExternalData() cannot be called on ChartDataRendererBase")
	}
}