...
extension UIViewController {
    ...
    // new apis from v3.3
    func noticeSuccess(text: String, autoClear: Bool = false, autoClearTime: Int = 1) {
    ...
    func successNotice(text: String, autoClear: Bool = true) {
        SwiftNotice.showNoticeWithText(NoticeType.success, text: text, autoClear: autoClear, autoClearTime: 2)
    }
    func errorNotice(text: String, autoClear: Bool = true) {
        SwiftNotice.showNoticeWithText(NoticeType.error, text: text, autoClear: autoClear, autoClearTime: 2)
    }
    ...
    func noticeOnlyText2(text: String) {
...
class SwiftNotice: NSObject {
    ...
    static func noticeOnStatusBar(text: String, autoClear: Bool, autoClearTime: Int) {
        ...
        let window = UIWindow()
        window.backgroundColor = UIColor.NavBarColor()
        let view = UIView()
